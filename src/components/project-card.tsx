...
export function ProjectCard({ project, index }: Props) {
  ...
  return (
    <motion.article
      ...
      className="group glass relative flex h-full flex-col overflow-hidden rounded-xl transition-colors duration-500 hover:!border-fg/[0.16]"
    >
      <Link
      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden">
        ...
        <div className="pointer-events-none absolute right-4 bottom-4 inline-flex h-9 w-9 items-center justify-center rounded-full border border-fg/15 bg-bg/60 text-fg/80 backdrop-blur-md transition-all duration-500 ease-out-expo group-hover:border-accent/50 group-hover:text-accent">
